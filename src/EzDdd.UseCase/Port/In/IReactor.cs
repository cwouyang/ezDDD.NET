...
/// <summary>
///     <c>IReactor</c> takes care of specific business rules whenever it receives a message from the
///     message bus. According to the received message, a reactor triggers a side effect such as
///     updating an aggregate, notifying frontend clients, or notifying another bounded context.
