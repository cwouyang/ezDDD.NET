...
/// </summary>
public sealed record DepositInput
(
    AccountId AccountId,
    Money Amount
) : IVersionedInput
...
public sealed class DepositUseCase
    (IRepository<BankAccount, AccountId, IInternalDomainEvent> repository) : IUseCase<DepositInput, DepositOutput>
{
