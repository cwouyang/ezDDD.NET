...
#region Complex Scenarios
    ...
    public void InternalDomainEventDto_WithNestedJsonInJsonEvent_ShouldSerialize()
    {
        var eventData = new
        {
            aggregateId = "order-123", items = new[] { new { productId = "p1", quantity = 2 }, new { productId = "p2", quantity = 1 } }
        };
    ...
    public void InternalDomainEventDto_WithComplexJsonEvent_ShouldPreserveStructure()
    {
        ...
        Dictionary<string, JsonElement>? parsedEvent = JsonSerializer.Deserialize<Dictionary<string, JsonElement>>(deserialized.JsonEvent);
...
#region Specific Features
    ...
    public void InternalDomainEventDto_Metadata_ShouldOnlyAcceptStringValues()
    {
        InternalDomainEventDto dto = new()
        {
            ...
            Metadata = new Dictionary<string, string>
            {
                ["userId"] = "user-1", ["correlationId"] = "corr-123", ["causationId"] = "cause-456"
            }
        };
